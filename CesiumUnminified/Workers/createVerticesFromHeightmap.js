...
define(['./when-c2e8ef35', './Check-c4f3a3fc', './Math-a06249ed', './Cartesian2-a4e73c05', './Transforms-5147dead', './RuntimeError-6122571f', './WebGLConstants-4ae0db90', './ComponentDatatype-762ab5b7', './AttributeCompression-6b12d004', './IntersectionTests-5b749b93', './Plane-03b7eb6f', './WebMercatorProjection-ed47c368', './createTaskProcessorWorker', './EllipsoidTangentPlane-6c94f2fa', './OrientedBoundingBox-1caff401', './TerrainEncoding-606d92b3'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
