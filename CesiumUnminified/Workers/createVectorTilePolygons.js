...
define(['./when-c2e8ef35', './Check-c4f3a3fc', './Math-a06249ed', './Cartesian2-a4e73c05', './Transforms-5147dead', './RuntimeError-6122571f', './WebGLConstants-4ae0db90', './AttributeCompression-6b12d004', './IndexDatatype-755cb3fd', './IntersectionTests-5b749b93', './Plane-03b7eb6f', './createTaskProcessorWorker', './EllipsoidTangentPlane-6c94f2fa', './OrientedBoundingBox-1caff401', './Color-1c5382f1'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
